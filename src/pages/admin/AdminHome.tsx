  ...
  return (
    <div className="flex flex-col gap-6">
      ...
      <section className="grid grid-cols-2 gap-4 sm:grid-cols-3 lg:grid-cols-5">
        {[
          { label: t("admin.metrics.totalLeads"), value: metrics.totalLeads },
            ...
            filtered.map((client) => (
              ...
              >
                <div>
                  ...
                  <p className="text-xs text-content-muted">{client.email || client.phone}</p>
                </div>
                <button
                  type="button"
                  onClick={() =>
